...
Paraméterek: A kétoldalú szűrőt két paraméterrel lehet irányítani: $\sigma_r$ és $\sigma_s$. Ezen paraméterek hatását \aref{fig:bilateral}. ábrán láthatjuk.
\begin{itemize}
...
\begin{figure}[h!]
\centering
\epsfig{file=kepek/bilateral.png,scale=0.65}
\caption{A $\sigma_r$ és a $\sigma_s$ paraméterek hatása, valamint a Gauss elmosással való összehasonlítás.} 
\label{fig:bilateral}
\end{figure}

 \Aref{fig:bilateral1}. ábrán láthatunk egy példát a kétoldalú szűrő elmosására egy bemeneti képen amin az élek megőrzésre kerülnek.
